import{g as o,c as U,r as M,k as c,f as d,l as L,m as E,h as C,i as I,u as P,j as D,w as S,t as T,x as $,b as F,s as B,p as k}from"./firebace-Cb3kG9CG.js";import{h as J,c as N}from"./requests-8AYIeyfP.js";import{J as O}from"./just-validate.es-C73wyOde.js";const i=o(".one-new__operation"),u=o(".one-new"),f=o(".page"),j=new URLSearchParams(window.location.search),s=j.get("id"),R=U.get("Role");async function q(e,n){if(!(!u||!i))if(R==="admin"||n===e.userId){const t=o(".one-new__edit",i);if(!t)return;t.addEventListener("click",async()=>{u.style.display="none",H(e)})}else i.remove()}function H(e){if(!f)return;const n=M("div","change-info");n.innerHTML=`
    <div class="container">
